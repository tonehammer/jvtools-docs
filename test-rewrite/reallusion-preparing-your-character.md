...
*This is a test rewrite of the [original page](/reallusion-importer/getting-started/preparing-your-character/).*
...
![Character Creator's Export USD (Omniverse) panel](/reallusion-importer/static/cc-export-usd-settings.png)
...
![](/reallusion-importer/static/cc5-export-settings.png)
...
![The iClone export menu](/reallusion-importer/static/iclone-export-menu.png)
...
![Character Creator's Motion Import Settings dialog — defaults are fine](/reallusion-importer/static/cs5-import-external-motion.png)
...
To bring the character's motion in with it, export with the animation baked in — the tool reads the embedded FBX animation automatically, and you can add more clips later. See [Animation](/reallusion-importer/using/animation/).
...
With your character exported correctly, head to the [Quick Start](/reallusion-importer/getting-started/quick-start/) to import it.
